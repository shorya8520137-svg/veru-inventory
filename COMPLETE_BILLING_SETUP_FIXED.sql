...
INSERT INTO store_inventory (product_name, sku, category, stock, price, gst_percentage) VALUES
...
SELECT 'store_inventory' as table_name, COUNT(*) as record_count FROM store_inventory
UNION ALL
...
SELECT product_name, sku, price, stock FROM store_inventory LIMIT 5;
