-- =====================================================
-- COMPREHENSIVE DATABASE FIXES FOR API ERRORS
-- =====================================================
...
-- 5. Ensures all required tables exist with proper structure
-- =====================================================
...
-- Create database if it doesn't exist (just in case)
...
-- =====================================================
-- The users table is referenced in multiple controllers and needs proper structure
...
-- =====================================================
-- 2. ADD USERNAME COLUMN TO USERS TABLE (IF NOT EXISTS)
-- =====================================================
-- The websiteOrderController.js references u.username but the users table might only have 'name'
-- We'll add a username column and populate it from the name field
...
-- Update username column with name values where username is null
UPDATE `users` 
...
-- =====================================================
-- 4. ENSURE API_KEYS TABLE EXISTS WITH PROPER STRUCTURE
-- =====================================================
-- The API keys table is essential for API authentication
...
-- =====================================================
-- 5. ENSURE WEBSITE_CATEGORIES TABLE EXISTS
-- =====================================================
-- Make sure the categories table exists with proper structure
...
-- =====================================================
-- 6. ENSURE WEBSITE_PRODUCTS TABLE EXISTS
-- =====================================================
-- Products table for the website integration
...
-- =====================================================
-- 7. ENSURE WEBSITE_ORDERS TABLE EXISTS
-- =====================================================
-- Orders table for website order management
...
-- =====================================================
-- 8. ENSURE WEBSITE_ORDER_ITEMS TABLE EXISTS
-- =====================================================
...
-- =====================================================
-- 9. VERIFY AND CREATE MISSING INDEXES
-- =====================================================

-- Additional indexes that might be missing
CREATE INDEX IF NOT EXISTS `idx_api_usage_logs_response_status` ON `api_usage_logs` (`response_status`);
CREATE INDEX IF NOT EXISTS `idx_website_orders_tracking_number` ON `website_orders` (`tracking_number`);

-- =====================================================
-- 10. INSERT DEFAULT CATEGORIES IF NONE EXIST
-- =====================================================

INSERT IGNORE INTO `website_categories` (`name`, `slug`, `description`, `sort_order`) VALUES
...
SELECT 
    ...
    COALESCE((SELECT COUNT(*) FROM users WHERE username IS NOT NULL), 0) as users_with_username_count,
...
SELECT 
    '✅ DATABASE SCHEMA FIXES COMPLETED SUCCESSFULLY!' as message,
    NOW() as completed_at,
    'All required tables and columns have been created or verified' as details;
